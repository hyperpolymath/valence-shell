...
|mkdir/rmdir |mkdir_rmdir_reversible |Coq, Lean 4, Agda, Isabelle,
Mizar, Z3

|touch/rm |create_delete_file_reversible |Coq, Lean 4, Agda, Isabelle,
Mizar, Z3

|obliterate |obliterate_irreversible |Coq, Lean 4, Agda, Isabelle,
Mizar, Z3
|===
