...
* Read PHASE6_M2_COMPLETE.md for technical details
* Explore `+proofs/lean4/+` for formal verification
* Try building your own verified operations

'''''

*Remember*: vsh is a research prototype. Use it to explore formally
verified computing, not for production systems (yet).
