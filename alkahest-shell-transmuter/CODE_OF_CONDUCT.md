...
|--------|---------|----------|
| **Email** | Open a [private security advisory](https://github.com/hyperpolymath/alkahest-shell-transmuter/security/advisories/new) | Detailed reports, sensitive matters |
...
2. The Alkahest Maintainers will review the report
...
If an Alkahest Maintainer is involved in an incident:
...
The Alkahest Maintainers will follow these guidelines in determining consequences:
...
2. Open a [private security advisory](https://github.com/hyperpolymath/alkahest-shell-transmuter/security/advisories/new) with subject line "Appeal: [Original Report ID]"
3. **Explain** why you believe the decision should be reconsidered
4. **Provide** any new information not previously available

**Appeals Process**

- Appeals are reviewed by a different Alkahest Maintainer than the original
...
- Open a [Discussion](https://github.com/hyperpolymath/alkahest-shell-transmuter/discussions) (for general questions)
- Open a [private security advisory](https://github.com/hyperpolymath/alkahest-shell-transmuter/security/advisories/new) (for private questions)
