...
git clone https://github.com/hyperpolymath/valence-shell.git cd
valence-shell
...
toolbox create valence-shell-dev toolbox enter valence-shell-dev #
...
valence-shell/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
