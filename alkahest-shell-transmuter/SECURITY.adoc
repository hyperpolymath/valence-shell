...
[arabic]
. Navigate to
https://github.com/hyperpolymath/alkahest-shell-transmuter/security/advisories/new[Report
a Vulnerability]
...
* This repository (`+hyperpolymath/alkahest-shell-transmuter+`) and all
its code
...
https://github.com/hyperpolymath/alkahest-shell-transmuter/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/alkahest-shell-transmuter/discussions[GitHub
Discussions]
...
_Thank you for helping keep Alkahest and its users safe._ 🛡️
