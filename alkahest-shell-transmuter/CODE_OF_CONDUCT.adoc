...
Alkahest a harassment-free experience for everyone, regardless of age,
...
|*Email* |Open a
https://github.com/hyperpolymath/alkahest-shell-transmuter/security/advisories/new[private
security advisory] |Detailed reports, sensitive matters
...
. The Alkahest Maintainers will review the report
...
The Alkahest Maintainers will follow these guidelines in determining
consequences:
...
. Open a
https://github.com/hyperpolymath/alkahest-shell-transmuter/security/advisories/new[private
security advisory] with subject line "`Appeal: [Original Report ID]`"
. *Explain* why you believe the decision should be reconsidered
. *Provide* any new information not previously available

*Appeals Process*

* Appeals are reviewed by a different Alkahest Maintainer than the
original
...
* Open a
https://github.com/hyperpolymath/alkahest-shell-transmuter/discussions[Discussion]
(for general questions)
* Open a
https://github.com/hyperpolymath/alkahest-shell-transmuter/security/advisories/new[private
security advisory] (for private questions)
