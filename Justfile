...
doctor:
    @echo "Running diagnostics for valence-shell..."
...
heal:
    @echo "Attempting auto-repair for valence-shell..."
...
help-me:
    @echo "=== valence-shell Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/valence-shell/issues/new"
    @echo ""
