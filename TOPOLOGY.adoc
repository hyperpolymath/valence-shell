...
[width="100%",cols="23%,13%,37%,27%",options="header",]
|===
...
|Rust impl |Property validation |`+lean4_proptest_correspondence.rs+`
|16 tests

|Rust impl |Extended validation |`+property_correspondence_tests.rs+`
|15 tests
