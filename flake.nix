{
  description = "valence-shell - {project-description}";
      ...
      in
      {
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P valence-shell.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/valence-shell $out/bin/  # Rust
            # cp bin/valence-shell $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/valence-shell";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-valence-shell" {
