...
. link:#built-in-commands[Built-in Commands]
. link:#external-commands[External Commands]
. link:#navigation[Navigation]
. link:#undoredo[Undo/Redo]
. link:#transactions[Transactions]
. link:#proof-references[Proof References]
. link:#common-workflows[Common Workflows]
...
*Key Difference*: External commands execute but don’t create undo
history.
...
*Version*: 0.7.1 (Phase 0 Sealing) *License*: MPL-2.0 *Verified*: 256+
theorems across 6 proof systems
